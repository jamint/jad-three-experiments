...
module.exports = {
  entry: {
    ...
    experience09: "./src/exp-09.js",
    experience10: "./src/exp-10.js",
  },
  output: {
    filename: "[name].js",
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      inject: true,
      filename: "experience-09.html",
      template: "./src/experience-09.html",
      chunks: ["experience09"],
    }),
    new HtmlWebpackPlugin({
      inject: true,
      filename: "experience-10.html",
      template: "./src/experience-10.html",
      chunks: ["experience10"],
    }),
