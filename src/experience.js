...
const tick = () => {
  ...
  // const distCameraToControlsTarget = camera.position.distanceTo(controls.target)
  // if (distCameraToControlsTarget < 50) console.log("too close")
  // if (distCameraToControlsTarget > 100) console.log("too far")
